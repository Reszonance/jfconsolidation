...
class SaveData:
    ...
    def initialize_default_data(self, debugging):
        ...
        if debugging:
            customer1 = Customer(
                            name="Olufunmi Olubunmi", 
                            address="2381 Heritage Drive", 
                            city="Calgary", 
                            state="Alberta", 
                            zip_code="T2V 2W2", 
                            phone="403-826-7845", 
                            email="olufunmi.olubunmi@gmail.com")
            consignee = Consignee(
                            name="Mr Tobiloba Oguh", 
                            address="11 Ibikunle Akintoye St.", 
                            city="Lagos", 
                            state="Lagos",
                            phone="456463534")
            ...
            customer2 = Customer("Ifeoma Oluwakemi", "4667 11th Ave SW", "Calgary", "Alberta", 
                                "T2P 1M6", "403-269-1543", "info@delicious-cart.com")
            consignee = Consignee("Azeez", "Apapa Rd., (Bhd. Leventis Motors) Box 108 Apapa", "Lagos", "Lagos", 
                                    "None", "08023122259")
